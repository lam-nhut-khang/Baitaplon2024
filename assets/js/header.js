...
<!-- PC -->
      ...
      <div class="row align-items-center">
        ...
        <div class="col col-8 col-lg-5 ">
          ...
          <datalist id="search-previous" hidden>
            <option value="Mũ bảo hiểm 3/4 đầu"></option>
            <option value="Mũ bảo hiểm trẻ em"></option>
            <option value="Mũ bảo hiểm 1/2 đầu"></option>
            <option value="Mũ bảo hiểm fullface"></option>
          </datalist>
        </div>
        <div class="col-md-3 d-none d-lg-flex text-end ms-auto fw-semibold gap-4 text-nowrap">
          
          <div>
            <a class="header__link" href="tel:+0354 395 490">
              <i class="fa-solid fa-phone"></i>
              <span>0354 395 490 </span>
            </a>
    ...
    function handleSearch() {
      const input = $("#js-search-input").val() || $("#js-search-input2").val();
    ...
    $("#js-mobile-menu").on("click", () => {
      document.querySelector("#mobile-left").style.transform = "translateX(0)";
    });
    ...
    $("#js-search-menu").on("click", () => {
      document.querySelector("#mobile-right").style.transform = "translateX(0)";
    });
